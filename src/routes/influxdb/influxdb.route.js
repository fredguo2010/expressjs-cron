...
router
  .route('/getDataByTagId')
  .get(validate(influxdbValidation.getInfluxDataByTagId), influxdbController.getInfluxDataByTagId);
router
  .route('/getDiffDataByTagId')
  .get(validate(influxdbValidation.getInfluxDataByTagId), influxdbController.getInfluxDiffDataByTagId);
router
  .route('/getDataByDeviceAndName')
  .get(validate(influxdbValidation.getInfluxDataByDeviceAndName), influxdbController.getInfluxDataByDeviceAndName);
